...
namespace EFCoreRelations.Data.Migrations
{
    ...
    [Migration("20210621141814_Rooms_Column_to_RentPost_Table")]
    partial class Rooms_Column_to_RentPost_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreRelations.Data.Models.RentPostPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EFCoreRelations.Data.Models.UserFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EFCoreRelations.Data.Models.RentPostPhoto", b =>
                {
                    b.HasOne("EFCoreRelations.Data.Models.RentPost", null)
                        .WithMany("RentPostPhotos")
            ...
            modelBuilder.Entity("EFCoreRelations.Data.Models.UserFavorite", b =>
                {
                    b.HasOne("EFCoreRelations.Data.Models.RentPost", "RentPost")
                        .WithMany()
                        .HasForeignKey("RentPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
